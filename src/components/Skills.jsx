  ...
  return (
    <div name="skills" className="w-full h-screen bg-[#0a192f] text-gray-300">
      ...
      <div className=" max-w-5xl mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-8 text-center py-8">
          ...
          <div className=" shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={AWS} alt="HTMLIcon" />
            <p className="my-4">AWS</p>
          </div>
          <div className=" shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={Mongo} alt="HTMLIcon" />
